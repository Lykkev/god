...
class agreeCommand extends Command {
  constructor(...args) {
    super(...args, {
      description: "Le da el rol de acuerdo establecido si el servidor lo tiene configurado.",
    });
  }
  ...
  async run(msg) {
    ...
    await msg.member.addRole(agreeRole.id, "Ejecutó el comando agree").catch(() => {});
