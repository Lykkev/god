    ...
    .on("messageReactionAdd", async (msg, emoji, uid) => {
      ...
      if (msg.reactions[pin] && msg.reactions[pin].count) {
        ...
        if (guildconfig && guildconfig.pinChannel && guildconfig.pinAmount && parseInt(guildconfig.pinAmount) <= msg.reactions[pin].count) {
          ...
          embedconstruct = {
            embed: {
              ...
              fields: [{
                ...
                name: "Mensaje",
                value: `[Subir](https://discordapp.com/channels/${msg.channel.guild.id}/${msg.channel.id}/${msg.id})`,
                inline: true,
              }],
              footer: {
          ...
          if (msg.content) embedconstruct.embed.description = msg.content || "Sin contenido";
